  ...
  return (
    <main className="min-h-screen flex flex-col bg-black">
                ...
                <>
                  ...
                  <Link
                    ...
                    className={cn(
                      'inline-flex items-center justify-center rounded-lg font-medium transition-all',
                      'h-9 px-4 text-sm',
                      'bg-gradient-to-r from-purple-600 to-violet-600 text-white hover:from-purple-700 hover:to-violet-700 border border-purple-500/50 shadow-lg shadow-purple-500/20'
                    )}
                  >
                    Sign up
                  </Link>
          ...
          <div className="flex-1 space-y-8 max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8">
              <div className="flex items-start gap-3 p-4 rounded-lg border border-white/5 bg-white/5">
                <FolderTree className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg border border-white/5 bg-white/5">
                <Lock className="w-5 h-5 text-fuchsia-400 mt-0.5 flex-shrink-0" />
                <div>
      ...
      <section className="max-w-7xl mx-auto w-full px-6 lg:px-8 py-20 lg:py-32 border-t border-white/5">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          <div className="group relative">
            <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-black/60 to-black/40 p-8 h-full transition-all duration-300 hover:border-purple-500/50 hover:shadow-xl hover:shadow-purple-500/10">
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-purple-500/10 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-lg bg-purple-500/20 border border-purple-500/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <FileText className="w-6 h-6 text-purple-400" />
                </div>
                <div className="text-sm font-mono text-purple-400 mb-2">Step 1</div>
          ...
          <div className="group relative">
            <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-black/60 to-black/40 p-8 h-full transition-all duration-300 hover:border-purple-500/50 hover:shadow-xl hover:shadow-purple-500/10">
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm font-mono text-purple-400 mb-2">Step 2</div>
          ...
          <div className="group relative">
            <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-black/60 to-black/40 p-8 h-full transition-all duration-300 hover:border-purple-500/50 hover:shadow-xl hover:shadow-purple-500/10">
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm font-mono text-purple-400 mb-2">Step 3</div>
      ...
      <section className="max-w-7xl mx-auto w-full px-6 lg:px-8 py-20 lg:py-32 border-t border-white/5">
        <div className="text-center mb-16">
          <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 mb-6">
            <Star className="w-3.5 h-3.5 mr-2 text-purple-400" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="group rounded-xl border border-white/10 bg-black/40 p-6 transition-all duration-300 hover:border-purple-500/50 hover:bg-black/60">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-lg bg-purple-500/20 border border-purple-500/30 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="max-w-7xl mx-auto w-full px-6 lg:px-8 py-20 lg:py-32 border-t border-white/5">
        <div className="text-center mb-16">
          <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 mb-6">
            <Code2 className="w-3.5 h-3.5 mr-2 text-purple-400" />
